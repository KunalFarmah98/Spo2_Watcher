...
public class DoctorDetails {
    ...
    public DoctorDetails(String name, String doctorID, String qualification, String address, String specialities, String hospital, int messageCharge, int appointmentCharge, float lat, float lang) {
        this.name = name;
